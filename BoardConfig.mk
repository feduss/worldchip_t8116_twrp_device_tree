...
DEVICE_PATH := device/worldchip/T8116
...
# Assert
TARGET_OTA_ASSERT_DEVICE := T8116
...
# Kernel
BOARD_KERNEL_CMDLINE := selinux=1 androidboot.selinux=enforcing buildvariant=user
...
TARGET_KERNEL_SOURCE := kernel/worldchip/T8116
